...
##################################################
# NUMBA-Compiled MIMO XPIC Equalizer
##################################################
...
class dual_pole_rx(gr.top_block, Qt.QWidget):
    def __init__(self):
        ...
        ##################################################
        # MIMO XPIC — post-PFB at 2 sps
        # Cross-pol cancellation + per-channel CMA.
        # QPSK and BPSK have different constellation
        # statistics so CMA can distinguish them and
        # converge to the correct demixing matrix.
        ##################################################
