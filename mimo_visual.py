...
class ConstellationCanvas(FigureCanvasQTAgg):
    ...
    def _setup_axes(self):
        ...
        self.ax.axhline(0, color='#444444', linewidth=0.5)
        self.ax.axvline(0, color='#444444', linewidth=0.5)
        self.ax.set_title(self.title, color='white', fontsize=14,
                          fontweight='bold')
